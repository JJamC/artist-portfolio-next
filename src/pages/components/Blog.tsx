      ...
      <div>
        ...
        <div className="blog-text">
          <p>
            ...
            Kenney Song Prize's Best Accompanist. Jay has since performed across
            the UK and Ireland as a soloist and chamber musician. As a classical
            pianist, Jay constructs his programmes with emotional arcs and
            narratives and aims to shed light on lesser known works. Jay
